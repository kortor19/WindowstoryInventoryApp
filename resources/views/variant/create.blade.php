                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('variant.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="control_side" type="text" class="form-control @error('control') is-invalid @enderror" name="control_side" value="{{ old('control_side') }}" required autocomplete="control_side" autofocus>
