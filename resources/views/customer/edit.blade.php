            ...
            <div class="card border-primary loginfrm">
                ...
                <div class="logo">
                    <img src="{{ asset('images/winlogo.png') }}" class="img-fluid" alt="Windowstory Limited">
                     <h3 class="card-title frm-title">{{ __('Update Customer Record') }}</h3>
                </div>             
                ...
                <div class="card-body">
                    ...
                    <!-- <input type="hidden" name="_token" value="{{ csrf_token() }}"> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select name="gender" class="form-control" id="gender" value="{{$customer->gender}}" required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phoneNumber" type="text" class="form-control @error('phoneNumber') is-invalid @enderror" name="phoneNumber" value="{{$customer->phoneNumber}}" required autocomplete="phoneNumber">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id = "address" class = "form-control @error('address') is-invalid @enderror" name="address" col="10" row="5">{{$customer->address}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control @error('state') is-invalid @enderror" value="{{$customer->state}}" name="state" required autocomplete="state">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" value="{{$customer->country}}" name="country" required autocomplete="country">
                            </div>
                        </div>
